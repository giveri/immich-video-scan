...
{#if $videoFaceProgress}
  <div
    class="fixed bottom-6 start-1/2 -translate-x-1/2 z-50 w-64 rounded-lg border bg-gray-100 p-3 text-sm shadow-md dark:border-immich-dark-gray dark:bg-immich-dark-gray pointer-events-none"
  >
